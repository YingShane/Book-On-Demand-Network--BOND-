...
def compare_two_images(image_path_1, image_path_2):
    ...
    # Step 4: Visualize the images with annotations and pHash
...
image_path_2 = 'images/book6.jpg'  # Second image (book cover)

# Run the comparison
phash_score = compare_two_images(image_path_1, image_path_2)
